...
function [BMC, p_alpha_predcted, p_hat_alpha_inferred] = BMC_calculation_function2(pred_alp,pred_bet,proir,gt_ratings,x,alpha,resolution)
   ...
   % resolution = 200;
    ...
    if pred_alp > 1 & pred_bet > 1 %check the beta distribution is bell shape
        ...
        [p_hat_alpha_inferred] = my_likely_area_inferred2(resolution,alpha,alpha_likely_index,x,alp,bet,proir,gt_ratings);
